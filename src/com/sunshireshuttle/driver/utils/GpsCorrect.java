...
/**
 * Created by caroline on 2016/11/30.
 */
...
public class GpsCorrect {
    ...
    public static Location transfrom(Location location) {
    ...
    private static void transform(double wgLat, double wgLon, double[] latlng) {
